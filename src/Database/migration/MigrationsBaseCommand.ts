 ...
 */
export abstract class MigrationsBaseCommand extends BaseCommand {
  constructor (public application: Application, public kernel: KernelContract) {
    super(application, kernel);
    application.appRoot = application.getBasePath();
  }
  ...
  protected printPreviewMessage () {
    const sourceDir = this.application.getBasePath()
    ...
    /**
         ...
         */
    const compiledAt = DateTime.fromISO('')
